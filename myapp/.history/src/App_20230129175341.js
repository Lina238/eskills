    ...
    <> 
      ...
      <Router>     
        <Routes>
          ...
          <Route exact path='/signin' element={<SignInSignUp />} render={(userLogin) => <SignInSignUp {...userLogin} authed={true}/>  } />
          <Route exact path='/SignUp' element={<SignUp/> } render={(userLogin) => <SignInSignUp {...userLogin} authed={true}/> }/>
