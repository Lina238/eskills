...
function AjouteAnnonce (){
    ...
    const [val, setVal] = React.useState({titre:'',niveau:'',discription:'', image:'', price:'', phone:'', address:'',service:'',wilaya:'',photo:''})
    const [selectLevel, setLevel] = React.useState([])
    "id": 1,
    "titre": "Prof de maths et physique  (MathÃ©matiques)",
    "niveau": "Enseignant\t\t(Education Nationale)\n\n\t\t avec +5 annÃ©es d'expÃ©rience    \n\n     Secondaire",
    "discription": "Prof donner des cours particuliers maths et physique de toutes les niveaux",
    "image": "['https://dz.professeurparticulier.com/img-106944-professeur-cours-particuliers.jpg']",
    "mode": "Travail Ã  distance (TÃ©lÃ©phone, Internet, webcam, courrier...)",
    "nom": "Ahmed",
    "prix": "A partir de 2000 DA /heure",
    "lieu": "Alger"
    ...
    const onHandleChange = (e) => {
            if(val.name !== "" && val.Fname !== "" && val.module !== "" &&  val.email !== ""  &&  val.price !== "" && val.phone !== ""  && val.wilaya !== ""  && selectLevel !== "" ) 
            {
    ...
    const submitForm = (e) => {
        ...
        if(val.name !== "" || val.email !== "" || val.Fname !== "" || val.phone !== ""  || val.address !== "" || val.wilaya !== "" || val.service !== "" ||  val.price !== "" || val.module !== "" ||selectLevel.length > 0 || like.length > 0 || val.photo!=='' ){
