...
function AjouteAnnonce (){
    ...
    , discription:'', address:'',service:'',mode:'',
    wilaya:'',photo:''})
    ...
    const onHandleChange = (e) => {
            if(val.name !== "" && val.Fname !== "" && val.module !== "" &&  val.email !== ""
              &&  val.price !== "" && val.discription !== ""  && val.wilaya !== ""   ) 
            {
    ...
    const submitForm = (e) => {
        ...
        val.Fname !== "" || val.discription !== ""
          || val.address !== "" || val.wilaya !== "" 
          || val.service !== "" ||  val.price !== ""
           || val.module !== "" || val.photo!=='' ){
            const  state = {
    ...
    const resetBtn = () => {
        setVal({name:'',Fname:'',module:'',  email:'', price:'', discription:'', address:'',
         service:'', wilaya:'', level:'',photo:'',mode:''})
        setLevel([])
    }
