      ...
      <div className='menu-container' ref={menuRef}>
        ...
        <div className={`dropdown-menu ${open? 'active' : 'inactive'}`} >
          ...
          <ul>
            ...
            <DropdownItem  function={moncompte()} img = {edit} text = {"Mes services"}/>
            <DropdownItem function={moncompte()} img = {settings} text = {"Mes favoris"}/>
            <DropdownItem function={moncompte()}  img = {logout} 
            // onClick={logout()} 
            text = {"Logout"}/>
          </ul>
        </div>
