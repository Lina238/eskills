        ...
        if(username&&password)
        {
           ...
           { fetch('http://127.0.0.1:8000/auth/', {
            ...
            .then(
              ...
              //  if(data.token!=null){
              //   l=document.getElementById("reg")
              //   l.innerHTML = el.innerHTML+"<Link to={{pathname:'/User',data:data.token}}>continue</Link>";
        ...
        <div className="register" id="reg">
            <div className="col-1">
               ...
               <label>The password can't be Empty</label>:""}  
                    <button className='btn2' onClick={this.login}>Sign In</button>
                    <Link to ="/SignUp">
